...
export default function Card({data}) {
    return (
        <div className="flex flex-col w-[300px] h-full justify-between max-w-2xl m-2 mx-auto border rounded-xl overflow-hidden shadow-lg bg-white hover:scale-105 transition duration-200 ease-in-out">
            ...
            <div className="flex flex-col-reverse  justify-around w-full p-4 gap-5 w-auto space-y-4">
                ...
                <div className="desc flex flex-row  justify-between w-auto items-center">
